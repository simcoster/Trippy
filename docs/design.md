...
left under the title and again in the sidebar. A small README link
sits at the top right; the tall one stays at the bottom of the sidebar. `demo_query_quota` stores a SHA-256 of `TRIPPY_DEMO_QUOTA_PEPPER`
